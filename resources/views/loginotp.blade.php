    ...
    <div class="container-fluid">
        <div class="row">
            <div class="bg-grey1 col-md-4 col-lg-4 col-sm-4 col-xs-12">
                ...
                <form class="mt-5 black_intl" method="post" action="{{ route('login.login_otp') }}">
                    {{ csrf_field() }}                                        
                    {{ method_field('POST') }}
                    ...
                    <div class="form-group row pt-3 pb-2 m-auto col-md-11">
                        <label class="text-left text-white">Enter the code sent to {{ $contact_number }}</label>

                    </div>
                    <a href="{{ route('login')}}"  id="resend" class="text-white row pt-3 m-auto col-md-11">
                        <h5>Resend code</h5>
